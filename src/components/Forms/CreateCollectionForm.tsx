...
export const CreateCollectionForm = ({
    ...
    addCollection: (newCollection: ICollection) => void
    close: () => void
}) => {
    ...
    const handleAddCollection = useCallback(
        ...
        [title, description, color, addCollection, close]
    )
                                ...
                                {({ open }) => (
                                    <>
                                        ...
                                        >
                                            <Popover.Panel
                                                static
                                                className="-translate-x-1/4 -translate-y-full absolute left-1/2 transform z-10"
                                            >
